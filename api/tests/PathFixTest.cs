...
namespace api.Tests {
    public class PathFixTest {
        ...
        public void TestFix_AuthorDash() {
            ...
            const string expected = "/mnt/csafe/Houston Persistence/Barrel F/Bullet 50/Houston Persistence - Barrel F - Bullet 50 - Land 5 - Sneox2 - 20x - auto light left image +20 perc. - Threshold 2 - Resolution 4 - Jozef Lamfers.x3p";
        ...
        public void TestFix_MagnificationDash() {
            ...
            const string expected = "/mnt/csafe/Houston Persistence/Barrel J/Bullet 13/Houston Persistence - Barrel J - Bullet 13 - Land 1 - Sneox 1 - 20x - autolight left image +20% & x10 - Threshold 2 - Resolution 4 - Jozef Lamfers.x3p";
            string result = PathFixes.fix(pathname);
